...
// 引入组件
const FormRulesOne = defineAsyncComponent(() => import('/@/views/example/pages/formRules/component/formRulesOne.vue'));
const FormRulesTwo = defineAsyncComponent(() => import('/@/views/example/pages/formRules/component/formRulesTwo.vue'));
const FormRulesThree = defineAsyncComponent(() => import('/@/views/example/pages/formRules/component/formRulesThree.vue'));
